...
// @route   PATCH /api/users/update-profile/:id
...
// @route   PATCH /api/users/staffs/:id
// @access  Private (admin)
...
// @desc    Xóa mềm nhân viên
// @route   DELETE /api/users/staffs/soft-delete/:id
// @access  Private (admin)
...
// @desc    Lấy danh sách nhân viên đã xóa mềm
// @route   GET /api/users/trash-staffs
// @access  Private (admin)
...
// @desc    Khôi phục nhân viên đã xóa mềm
// @route   PATCH /api/users/staffs/restore-deleted/:id
// @access  Private (admin)
...
// @desc    Xóa vĩnh viễn nhân viên
// @route   DELETE /api/users/staffs/:id
// @access  Private (admin)
