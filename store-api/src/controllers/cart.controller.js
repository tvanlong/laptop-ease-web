...
// @desc    Tăng số lượng sản phẩm trong giỏ
// @route   PATCH /api/carts/:userId/increase
// @access  Private (member)
...
// @desc    Giảm số lượng sản phẩm trong giỏ
// @route   PATCH /api/carts/:userId/decrease
// @access  Private (member)
...
// @route   DELETE /api/carts/:userId/all
// @access  Private (member)
