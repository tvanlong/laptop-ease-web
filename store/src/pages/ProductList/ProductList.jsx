...
function ProductList({ setProgress }) {
  const navigate = useNavigate()
  const queryParamsConfig = useQueryParamsConfig()
  const { data, isFetching, isLoading } = useVersions(
  ...
  return (
    ...
    Danh sách sản phẩm
      ...
      <div className='mt-10 lg:hidden flex justify-end gap-4 border-t border-gray-300'>
        <SortProductListMobile pathname={path.productList} queryParamsConfig={queryParamsConfig} />
      ...
      <div className='mt-10 lg:grid lg:grid-cols-12 gap-8'>
        ...
        <div className='xl:col-span-10 lg:col-span-9'>
          <SortProductList pathname={path.productList} queryParamsConfig={queryParamsConfig} />
          {!isFetching ? (
